...
var preview = function preview(request, response, options) {
  return new _bluebird2.default(function (resolve, reject) {
    var req = _request2.default.post(options.publicUriForPreview || 'http://jsreport.net/temp', function (err, resp, body) {
      ...
      response.content = new Buffer('<iframe style="height:100%;width:100%" src="https://view.officeapps.live.com/op/view.aspx?src=' + encodeURIComponent((options.publicUriForPreview || 'http://jsreport.net/temp') + '/' + body) + '" />');
